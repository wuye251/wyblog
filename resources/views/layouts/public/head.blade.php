...
<div class="head">
	<div class="head-body">
		...
		<div class="container_kindView">
			<a class="container_home"  href="@yield('home_url')">首页</a>
			<a class="container_blog"  href="@yield('blog_url')">@yield('view1')</a>
			...
			<a class="createBlog" href="@yield('createBlog_url')">@yield('createBlog')</a>
		</div>
